...
import (
	...
	"github.com/Mirantis/cri-dockerd/config/container"
...
type DockerClientInterface interface {
	...
	PullImage(image string, auth registry.AuthConfig, opts dockertypes.ImagePullOptions) error
	RemoveImage(
		image string,
