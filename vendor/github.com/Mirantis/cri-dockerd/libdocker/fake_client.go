...
type FakeDockerClient struct {
	...
	ImageIDsNeedingAuth  map[string]registry.AuthConfig
...
func NewFakeDockerClient() *FakeDockerClient {
	return &FakeDockerClient{
		...
		ImageIDsNeedingAuth: make(map[string]registry.AuthConfig),
...
func (f *FakeDockerClient) CreateContainer(
	c containerconfig.CreateConfigWrapper,
...
func (f *FakeDockerClient) isAuthorizedForImage(image string, auth registry.AuthConfig) bool {
...
func (f *FakeDockerClient) ResetImages() {
	...
	f.ImageIDsNeedingAuth = make(map[string]registry.AuthConfig)
}
...
func (f *FakeDockerPuller) Pull(image string, _ []v1.Secret) error {
	return f.client.PullImage(image, registry.AuthConfig{}, dockertypes.ImagePullOptions{})
}
